	...
	document.querySelector("#submit").addEventListener("click", function(event){
		...
		if (reply_gender_male === true && reply_bpl_yes === true){
		 ...
		 if(reply_gender_male === true && reply_bpl_no === true){
			if(age >= 58){
				result += "<h1> You are eligible for the following schemes : </h1> <br>";
				var message = "<table> <tr><td>Name of Scheme</td> <td>Annual Income Limit</td> </tr> <tr><td>Vridhjan Samman Yojna</td> <td>Rs. 48000</td></tr> <tr><td>Vishesh yogya jan Samman Yojna(Specially abled with greater than 40% disablity)</td> <td>Rs. 60000</td></tr></table>";
				result += message;
			}
		}
		 if(reply_gender_male === true && reply_bpl_yes === true && age == 59){
			...
			result += "<h1> You are eligible for the following schemes : </h1> <br>";
			var message = "<table> <tr><td>Name of Scheme</td> <td>Annual Income Limit</td> <tr><td>Nishakt Pension Yojana (For specially abled people with greater than 80% disablitiy)</td> <td>	As mentioned in the BPL Scheme of the Central Government</td> </tr> <tr><td>Vridhjan Samman Yojna</td> <td>Rs. 48000</td></tr> <tr><td>Vishesh yogya jan Samman Yojna(Specially abled with greater than 40% disablity)</td> <td>Rs. 60000</td></tr> </table>";
			result += message;
		}
		 if (reply_gender_male === true && reply_bpl_yes === true){
			if (age >=18 && age < 58){
				result += "<h1> You are eligible for the following schemes : </h1> <br>";
				var message = "<table><tr><td>Name of Scheme</td> <td>Annual Income Limit</td></tr> <tr><td>Nishakt Pension Yojana (For specially abled people with greater than 80% disablitiy)</td> <td>	As mentioned in the BPL Scheme of the Central Government</td> </tr> <tr><td>Vishesh yogya jan Samman Yojna(Specially abled with greater than 40% disablity)</td> <td>Rs. 60000</td></tr></table>";
				result += message;
			}
		}
		 if (reply_gender_male === true && reply_bpl_no === true){
			if(age < 58){
				result += "<h1> You are eligible for the following schemes : </h1> <br>";
				var message = "<table><tr><td>Name of Scheme</td> <td>Annual Income Limit</td></tr> <tr><td>Vishesh yogya jan Samman Yojna(Specially abled with greater than 40% disablity)</td> <td>Rs. 60000</td></tr> </table>";
				result += message;
			}
		}
		 ...
		 if (reply_gender_female === true && reply_bpl_no === true && age >= 55){
			result += "<h1> You are eligible for the following schemes : </h1> <br>";
			var message = "<table> <tr><td>Name of Scheme</td> <td>Annual Income Limit</td> </tr> <tr><td>Vridhjan Samman Yojna</td> <td>Rs. 48000</td></tr> <tr><td>Vishesh yogya jan Samman Yojna(Specially abled with greater than 40% disablity)</td> <td>Rs. 60000</td></tr> <tr><td>Ekalnaari Samaan Yojna(For divorced/widowed women)</td> <td>Rs. 48000</td></tr></table>";
			result += message;
		}
		 if(reply_gender_female === true && reply_bpl_yes === true && age >=40 && age < 55){
			result += "<h1> You are eligible for the following schemes : </h1> <br>";
			var message = "<table><tr><td>Name of Scheme</td> <td>Annual Income Limit</td> </tr>  <tr><td>Vidhwa Pension Yojana(For widowed women)</td> <td>As mentioned in the BPL scheme of the Central Government</td></tr> <tr><td>Nishakt Pension Yojana (For specially abled people with greater than 80% disablitiy)</td> <td>	As mentioned in the BPL Scheme of the Central Government</td> </tr> <tr><td>Ekalnaari Samaan Yojna(For divorced/widowed women)</td> <td>Rs. 48000</td></tr> <tr><td>Vishesh yogya jan Samman Yojna(Specially abled with greater than 40% disablity)</td> <td>Rs. 60000</td></tr></table>";
			result += message;
		}
		 ...
		 if (reply_gender_female === true && reply_bpl_no === true && age >= 18 && age < 55){
			result += "<h1> You are eligible for the following schemes : </h1> <br>";
			var message = "<table><tr><td>Name of Scheme</td> <td>Annual Income Limit</td></tr> <tr><td>Ekalnaari Samaan Yojna(For divorced/widowed women)</td> <td>Rs. 48000</td></tr> <tr><td>Vishesh yogya jan Samman Yojna(Specially abled with greater than 40% disablity)</td> <td>Rs. 60000</td></tr> </table>"
			result += message;
		}
